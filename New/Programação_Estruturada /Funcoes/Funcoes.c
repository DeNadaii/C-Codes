...
// Assinatura de função: é a declaração que especifica o nome da função, o tipo de retorno e os tipos 
// (e opcionalmente os nomes) dos parâmetros que ela recebe.
// Ela serve para informar ao compilador como a função deve ser chamada e o que ela retorna, antes mesmo de sua implementação completa.
...
//prototipo de funcoes. implementação completa.
int funcaoSubtracao(int a, int b){
    return a-b;
}